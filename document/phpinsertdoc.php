...
*/
    ...
    */
    ...
    /*$sql ="INSERT 
      ...
      //$sql= "INSERT INTO `documents`( `doc_num`, `doc_title`, `doc_start_date`, `doc_to_date`, `doc_status`, `doc_file_name`) 
               // VALUES ('Doc_num','Doc_title','start_date','doc_to_date','doc_status','doc_file_name')";

        //$sql= "INSERT INTO `documents`( `doc_num`, `doc_title`, `doc_start_date`, `doc_to_date`, `doc_status`, `doc_file_name`) 
            //VALUES ('000005','ไม่ทราบ','2022-03-03','2022-03-04','Active','ไม่ทราบ.doc')";
